...
const CertificateCard = memo(({ certificate, onViewCertificate }) => {
    ...
    return (
        <motion.div
            ...
            className="group bg-dark-glass backdrop-blur-xl border border-dark-glassBorder rounded-3xl shadow-glass hover:shadow-glass-hover 
                transition-all duration-500 overflow-hidden cursor-pointer transform hover:scale-[1.02] relative"
